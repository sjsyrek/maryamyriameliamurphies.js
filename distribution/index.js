'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _throwError$defines$d;var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol?"symbol":typeof obj;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value" in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:true,configurable:true,writable:true});}else {obj[key]=value;}return obj;}function _toConsumableArray(arr){if(Array.isArray(arr)){for(var i=0,arr2=Array(arr.length);i<arr.length;i++){arr2[i]=arr[i];}return arr2;}else {return Array.from(arr);}}function _possibleConstructorReturn(self,call){if(!self){throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return call&&(typeof call==="object"||typeof call==="function")?call:self;}function _inherits(subClass,superClass){if(typeof superClass!=="function"&&superClass!==null){throw new TypeError("Super expression must either be null or a function, not "+typeof superClass);}subClass.prototype=Object.create(superClass&&superClass.prototype,{constructor:{value:subClass,enumerable:false,writable:true,configurable:true}});if(superClass)Object.setPrototypeOf?Object.setPrototypeOf(subClass,superClass):subClass.__proto__=superClass;}function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}} /*
...
// API
exports.default=(_throwError$defines$d={throwError:throwError,defines:defines,dataType:dataType,type:type,typeCheck:typeCheck,partial:partial,$:$,flip:flip,id:id,constant:constant,until:until,and:and,or:or,not:not,even:even,odd:odd,isEmpty:isEmpty,show:show,print:print,isEq:_isEq,isNotEq:isNotEq,EQ:EQ,LT:LT,GT:GT,compare:_compare,lessThan:lessThan,lessThanOrEqual:lessThanOrEqual,greaterThan:greaterThan,greaterThanOrEqual:greaterThanOrEqual,max:max,min:min,mempty:mempty,mappend:_mappend,mconcat:mconcat,fmap:fmap,fmapReplaceBy:fmapReplaceBy,pure:pure,ap:_ap,apFlip:apFlip,then:then,skip:skip,liftA:liftA,liftA2:liftA2,liftA3:liftA3,inject:inject,bind:_bind,chain:_chain,bindFlip:bindFlip,join:join,liftM:liftM,Do:Do,fold:fold,foldMap:foldMap,foldr:_foldr,traverse:_traverse,mapM:mapM,sequence:sequence,Nothing:Nothing,just:just,maybe:maybe,isMaybe:isMaybe,isJust:isJust,isNothing:isNothing,fromJust:fromJust,fromMaybe:fromMaybe,maybeToList:maybeToList,listToMaybe:listToMaybe,catMaybes:catMaybes,mapMaybe:mapMaybe},_defineProperty(_throwError$defines$d,'mapMaybe',mapMaybe),_defineProperty(_throwError$defines$d,'unit',unit),_defineProperty(_throwError$defines$d,'tuple',tuple),_defineProperty(_throwError$defines$d,'curry',curry),_defineProperty(_throwError$defines$d,'fromArrayToTuple',fromArrayToTuple),_defineProperty(_throwError$defines$d,'fromTupleToArray',fromTupleToArray),_defineProperty(_throwError$defines$d,'fst',fst),_defineProperty(_throwError$defines$d,'isTuple',isTuple),_defineProperty(_throwError$defines$d,'snd',snd),_defineProperty(_throwError$defines$d,'swap',swap),_defineProperty(_throwError$defines$d,'uncurry',uncurry),_defineProperty(_throwError$defines$d,'emptyList',emptyList),_defineProperty(_throwError$defines$d,'list',list),_defineProperty(_throwError$defines$d,'listRange',listRange),_defineProperty(_throwError$defines$d,'listFilter',listFilter),_defineProperty(_throwError$defines$d,'listRangeLazy',listRangeLazy),_defineProperty(_throwError$defines$d,'listRangeLazyBy',listRangeLazyBy),_defineProperty(_throwError$defines$d,'listAppend',listAppend),_defineProperty(_throwError$defines$d,'cons',cons),_defineProperty(_throwError$defines$d,'head',head),_defineProperty(_throwError$defines$d,'last',last),_defineProperty(_throwError$defines$d,'tail',tail),_defineProperty(_throwError$defines$d,'init',init),_defineProperty(_throwError$defines$d,'uncons',uncons),_defineProperty(_throwError$defines$d,'empty',empty),_defineProperty(_throwError$defines$d,'length',length),_defineProperty(_throwError$defines$d,'isList',isList),_defineProperty(_throwError$defines$d,'fromArrayToList',fromArrayToList),_defineProperty(_throwError$defines$d,'fromListToArray',fromListToArray),_defineProperty(_throwError$defines$d,'fromListToString',fromListToString),_defineProperty(_throwError$defines$d,'fromStringToList',fromStringToList),_defineProperty(_throwError$defines$d,'map',map),_defineProperty(_throwError$defines$d,'reverse',reverse),_defineProperty(_throwError$defines$d,'intersperse',intersperse),_defineProperty(_throwError$defines$d,'intercalate',intercalate),_defineProperty(_throwError$defines$d,'transpose',transpose),_defineProperty(_throwError$defines$d,'foldl',foldl),_defineProperty(_throwError$defines$d,'concat',concat),_defineProperty(_throwError$defines$d,'concatMap',concatMap),_defineProperty(_throwError$defines$d,'scanl',scanl),_defineProperty(_throwError$defines$d,'scanr',scanr),_defineProperty(_throwError$defines$d,'listInf',listInf),_defineProperty(_throwError$defines$d,'listInfBy',listInfBy),_defineProperty(_throwError$defines$d,'iterate',iterate),_defineProperty(_throwError$defines$d,'repeat',repeat),_defineProperty(_throwError$defines$d,'replicate',replicate),_defineProperty(_throwError$defines$d,'cycle',cycle),_defineProperty(_throwError$defines$d,'take',take),_defineProperty(_throwError$defines$d,'drop',drop),_defineProperty(_throwError$defines$d,'splitAt',splitAt),_defineProperty(_throwError$defines$d,'takeWhile',takeWhile),_defineProperty(_throwError$defines$d,'dropWhile',dropWhile),_defineProperty(_throwError$defines$d,'span',span),_defineProperty(_throwError$defines$d,'spanNot',spanNot),_defineProperty(_throwError$defines$d,'stripPrefix',stripPrefix),_defineProperty(_throwError$defines$d,'group',group),_defineProperty(_throwError$defines$d,'groupBy',groupBy),_defineProperty(_throwError$defines$d,'lookup',lookup),_defineProperty(_throwError$defines$d,'filter',filter),_defineProperty(_throwError$defines$d,'index',index),_defineProperty(_throwError$defines$d,'elemIndex',elemIndex),_defineProperty(_throwError$defines$d,'elemIndices',elemIndices),_defineProperty(_throwError$defines$d,'find',find),_defineProperty(_throwError$defines$d,'findIndex',findIndex),_defineProperty(_throwError$defines$d,'findIndices',findIndices),_defineProperty(_throwError$defines$d,'zip',zip),_defineProperty(_throwError$defines$d,'zip3',zip3),_defineProperty(_throwError$defines$d,'zipWith',zipWith),_defineProperty(_throwError$defines$d,'zipWith3',zipWith3),_defineProperty(_throwError$defines$d,'nub',nub),_defineProperty(_throwError$defines$d,'nubBy',nubBy),_defineProperty(_throwError$defines$d,'deleteL',deleteL),_defineProperty(_throwError$defines$d,'deleteLBy',deleteLBy),_defineProperty(_throwError$defines$d,'deleteFirsts',deleteFirsts),_defineProperty(_throwError$defines$d,'deleteFirstsBy',deleteFirstsBy),_defineProperty(_throwError$defines$d,'sort',sort),_defineProperty(_throwError$defines$d,'sortBy',sortBy),_defineProperty(_throwError$defines$d,'mergeSort',mergeSort),_defineProperty(_throwError$defines$d,'mergeSortBy',mergeSortBy),_defineProperty(_throwError$defines$d,'insert',insert),_defineProperty(_throwError$defines$d,'insertBy',insertBy),_throwError$defines$d);